  ...
  fixed: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        definition:
          "Pure expectations: forward rates are unbiased predictors of future spot rates; curve shape reflects rate expectations only. Liquidity preference: adds positive term premium for longer maturities. Market segmentation: yields determined by supply/demand in distinct maturity segments. Preferred habitat: investors deviate from preferred maturity only if compensated.",
      },
      {
      ...
      },
      {
        ...
        definition:
          "Bullet: concentrated in one maturity segment. Barbell: concentrated at short and long ends; has higher convexity than bullet for same duration. Ladder: distributed across maturities; provides reinvestment diversification. Barbell outperforms bullet when the yield curve flattens; bullet outperforms when the curve steepens.",
      },
    ],
  },
    ...
    flashcards: [
      {
        ...
        definition:
          "Private equity performance multiples. MOIC (Multiple on Invested Capital) = total value / invested capital. DPI (Distributions to Paid-In) = cash returned / paid-in capital (realized). RVPI (Residual Value to Paid-In) = NAV / paid-in capital (unrealized). TVPI = DPI + RVPI (total). IRR measures time-weighted return; MOIC measures total capital growth.",
      },
      {
        term: "Venture Capital Method",
        definition:
          "Startup valuation approach: (1) Estimate exit value at a terminal year. (2) Discount to present at the required return: Post-money value = Exit value / (1+r)^n. (3) Pre-money value = Post-money − new investment. (4) Investor ownership % = Investment / Post-money. Accounts for high failure rates through a high required return (often 30–60%).",
      },
      {
      ...
      },
      {
        ...
        definition:
          "Long/short equity: simultaneous long and short equity positions; net long bias typical. Global macro: directional bets across asset classes based on macro themes. Event-driven: merger arbitrage, distressed. Relative value: exploits pricing discrepancies (convertible arbitrage, fixed income arbitrage). Managed futures (CTA): systematic trend-following using futures.",
      },
    ],
  },
